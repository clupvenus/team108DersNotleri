...
public class MapMethodDepo {
    ...
    public static void isimSoyisimSiraliListeYazdir(Map<Integer, String> ogrenciMap) {
        ...
        for (String each : isimSoyisimSiraliSet) {
           //System.out.println(each);
            String[] duzenliYAzdirArr=each.split(" ");//[Ali,Can,101,11,H,MF]
            ...
            System.out.printf("%-6s   %-6s   %3s  %2s   %s  %s%n ",isim,soyIsim,no,sinif,sube,bolum);//Ali    Can   101  11    H   MF
